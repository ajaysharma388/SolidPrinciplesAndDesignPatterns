...
public class UserOperator {
    public static void main(String[] args) {
        Document doc = new Document("Algorithms", "Thomas J. Coreman", "This is the algorithms book.");
        ReadOnlyFile readOnlyFile = new ReadOnlyFile();
        readOnlyFile.read(doc);
        /* Notice the below line is now not accessible by the object of the readOnlyFile. Now our hierarchy is Liskov's Complaint
            which is explained in the previous module please compare the structural change from the previous package with this one
            to understand the principle in detail.
           i.e.,
           Liskov Substitution Principle: Objects of a superclass should be replaceable with objects of its subclasses
                                            without affecting the correctness of the program.
         */
        /* readOnlyFile.write(doc); */   // the structural change we do not have this method with the readOnlyFile.
        /*
