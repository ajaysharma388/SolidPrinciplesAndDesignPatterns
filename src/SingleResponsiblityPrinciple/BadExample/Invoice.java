package SingleResponsiblityPrinciple.BadExample;

import java.util.ArrayList;
import java.util.HashMap;
import SingleResponsiblityPrinciple.BadExample.Product;
...
public class Invoice {
    ...
    private StringBuilder getBillSummary() {
        int number = 1;
    ...
    void printBillSummary() {
        StringBuilder billSummary = this.getBillSummary();
