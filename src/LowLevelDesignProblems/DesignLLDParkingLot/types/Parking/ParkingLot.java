package LowLevelDesignProblems.DesignLLDParkingLot.types.Parking;

import LowLevelDesignProblems.DesignLLDParkingLot.types.Parking.Errors.ParkingFullException;
import LowLevelDesignProblems.DesignLLDParkingLot.types.Parking.Floors.ParkingFloor;
import LowLevelDesignProblems.DesignLLDParkingLot.types.Parking.Operations.ParkingRate;
import LowLevelDesignProblems.DesignLLDParkingLot.types.Parking.Operations.ParkingTicket;
import LowLevelDesignProblems.DesignLLDParkingLot.types.Parking.Panel.EntrancePanel;
import LowLevelDesignProblems.DesignLLDParkingLot.types.Parking.Panel.ExitPanel;
...
import LowLevelDesignProblems.DesignLLDParkingLot.types.ParkingCapacity;
...
import LowLevelDesignProblems.DesignLLDParkingLot.types.users.Address;
import static LowLevelDesignProblems.DesignLLDParkingLot.types.ParkingCapacity.*;
...
public class ParkingLot {
    ...
    public synchronized ParkingTicket getNewParkingTicket(Vehicle vehicle) throws ParkingFullException {
        ...
        ParkingTicket ticket = new ParkingTicket("1234",vehicle, /* this is dummy entry*/ new ParkingSpot(ParkingSpotType.LARGE));

        ticket.saveInDB();
        // if the ticket is successfully saved in the database, we can increment the parking spot count
        this.incrementSpotCount(vehicle.getVehicleType());
        this.activeTickets.put(ticket.getTicket_id(), ticket);
        return ticket;
    }
...
//        for (String key : parkingFloors.getKey()) {
