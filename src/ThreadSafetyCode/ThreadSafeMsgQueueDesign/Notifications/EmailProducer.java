...
import ThreadSafetyCode.ThreadSafeMsgQueueDesign.Actions.NotificationSystem;
...
public class EmailProducer implements ProducerService {
    private final String template;

    public EmailProducer() {
        this.template = "Email Update::";
    }
